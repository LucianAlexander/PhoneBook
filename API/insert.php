...
$stmt = $con->prepare("INSERT INTO persone (peer_nome, peer_cognome, peer_indirizzo, peer_tel, peer_eta) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("sssii", $nome, $cognome, $indirizzo, $tel, $eta);
